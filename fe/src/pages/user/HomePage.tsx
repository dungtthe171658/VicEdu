  ...
  return (
    <div className="home-container">
      <div className="home-hero">
        <h1>Chào mừng đến với VicEdu</h1>
        <p>Nền tảng học tập trực tuyến dành cho tương lai.</p>
        <button className="hero-btn">Khám phá các khóa học</button>
      </div>
